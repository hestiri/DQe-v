...
$$ prevalence = \sum_{i=1}^n uTime^i + \sum_{i=1}^n population^i$$

The application uses polynomial regression as a smoothing mechanism. That is, the users can set up the smoothing degree in the UI (maximum has been set to 4) and compare the difference in anomalies detected via a linear line and a smoother polynomial line. 
