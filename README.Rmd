...
To complement the visualizations provided in **Exploratory Analysis**, the **Density Plots** tab displays smoothed probability density function of a selected variable for a selected condition and time range (Figure 4). This tab allows the users to look at changes in distribution of their variable of interest, be it `prevalence`, `patient`, or `population`. Allowing the user to change the variable of interest will provide a more wholistic preview of data distribution.
...
Figure 5. Output of the Regression-based Analysis
